...
export default async function Form({ listId }: { listId: string }) {
  ...
  return (
    <form className="my-8" action={updateListWithId}>
      ...
      <button
        className="bg-gradient-to-br relative group/btn from-black  to-neutral-600 block w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset]  mb-5"
        type="submit">
        Edit
      </button>
